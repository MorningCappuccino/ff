...
return array(
	...
	"FEEDBACK_ACCOUNT_NOT_ACTIVATED_YET" => "Аккаунт не активирован. Подтвердить его можно нажав на ссылку в письме, отправленное на e-mail.",
	...
	"FEEDBACK_ACCOUNT_SUCCESSFULLY_CREATED" => "Аккаунт успешно создан. Пройдите по адресу в пиьсме, для подтверждения подлинности e-mail адреса.",
	...
	"FEEDBACK_VERIFICATION_MAIL_SENDING_SUCCESSFUL" => "Письмо с подвержеднием было успешно отправлено на ваш адрес.",
	"FEEDBACK_ACCOUNT_ACTIVATION_SUCCESSFUL" => "Активация прошла успешно. Теперь можно войти в аккаунт.",
	...
	"FEEDBACK_AVATAR_UPLOAD_SUCCESSFUL" => "Аватар успешно загружен.",
	...
	"FEEDBACK_CREATION_FAILED" => "Ошибка создания",
	"FEEDBACK_UPDATE_FAILED" => "Не удалось обновить запись",
	"FEEDBACK_DELETION_FAILED" => "Удаления прошло не удачно",
);
