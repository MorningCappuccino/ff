	...
	<div class="col-md-12 wrap">
		...
		<?php if ($this->data): ?>
			<form enctype="multipart/form-data" method="post" action="<?= Config::get('URL') . 'cinema/save' ?>" class="form">
				...
				<div class="form-group">
					<button type="button" name="button" class="btn btn-primary">Добавить фильм</button>
				</div>
								...
								<div class="col-lg-6">
									<div class="form-group text-center">
										...
										<div class="from-to-inputs">
											<div class="wrap-input from-input">
												<span>От</span>
												<input required type="text" name="cost_from" value="<?= $film->price_from ?>" class="form-control">
											</div>
											<div class="wrap-input to-input">
												<span>До</span>
												<input required type="text" name="cost_to" value="<?= $film->price_to ?>" class="form-control">
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-lg-6">
								<div class="form-group text-center">
									...
									<div class="from-to-inputs">
										<div class="wrap-input from-input">
											<span>От</span>
											<input required type="text" name="cost_from" value="0" class="form-control">
										</div>
										<div class="wrap-input to-input">
											<span>До</span>
											<input required type="text" name="cost_to" value="0" class="form-control">
										</div>
									</div>
								</div>
							</div>
