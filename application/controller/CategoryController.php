...
class CategoryController extends Controller
{
    ...
    {
        CategoryModel::createCategory(Request::post('category_name'));
        Redirect::to('madmin/category');
    }
    ...
    {
        $this->View->render('madmin/category/edit', array(
    ...
    {
        CategoryModel::updateCategory(Request::post('category_id'), Request::post('category_name'));
        Redirect::to('madmin/category');
    }
